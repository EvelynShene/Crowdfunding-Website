<?php
    ...
    $types = $requests->get_all_requests();
?>

<div class="box">
    <div class="box-header with-border">
          <h3 class="box-title">Requests Information</h3>
    ...
    <div class="box-body">
        <div id="table-type">
            <div class="table-responsive">
                <table id="myTable-request" title="allreq" class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
